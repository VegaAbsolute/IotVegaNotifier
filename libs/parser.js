class Parser
{
  ...
  {
      var res = true;
      res=res&&this._set_charge();
      res=res&&this._set_time(2,3,4,5);
      res=res&&this._set_temperature(6);
      res=res&&this._set_universal_int([7],'reason');
      res=res&&this._set_universal_boolean(8,'sensor_in_1');
      res=res&&this._set_universal_boolean(9,'sensor_in_2');
      res=res&&this._set_universal_boolean(10,'sensor_out_1');
      res=res&&this._set_universal_boolean(11,'sensor_out_2');
      res=res&&this._set_universal_boolean(12,'hall_1');
      res=res&&this._set_universal_boolean(13,'state_tamper');
      res=res&&this._set_universal_float([14,15,16,17],100,'sensor_rate_sum');
      ...
      res=res&&this._set_universal_float([24,25,26,27],100,'sensor_rate_0');
      return res;
  }
  sve_1_package_1()
  {
